    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="/?category=Life Style">Life style</a>
             <a class="dropdown-item" href="/?category=Social awareness">Social awareness</a>
            ...
            <a class="dropdown-item" href="/?category=Music">Music</a>
                    ...
                    <li class="nav-item"><a class="nav-link" href="/about">ABOUT</a></li>
                      ...
                      @if(Auth::user())
                      <li class="nav-item"><a class="nav-link" href="{{ route('posts.index') }}">MY POST </a></li>
                      @endif
                    </ul>
